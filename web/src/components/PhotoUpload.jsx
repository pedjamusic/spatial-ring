      ...
      {filename && (
        <div className="relative inline-block">
          ...
          <Button
            ...
            className="focus:outline-hidden absolute -right-2 -top-2 rounded-full bg-red-600 p-1 text-white shadow-glow shadow-red-600/50 hover:cursor-pointer hover:bg-red-700"
